...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		className.set ("assets/data/Alone.oep", __ASSET__assets_data_alone_oep);
		type.set ("assets/data/Alone.oep", AssetType.TEXT);
		className.set ("assets/data/testlvl.oel", __ASSET__assets_data_testlvl_oel);
		type.set ("assets/data/testlvl.oel", AssetType.TEXT);
		...
		className.set ("assets/images/checkpoint.png", __ASSET__assets_images_checkpoint_png);
		...
		className.set ("assets/images/nyasheet.png", __ASSET__assets_images_nyasheet_png);
		type.set ("assets/images/nyasheet.png", AssetType.IMAGE);
		...
		className.set ("assets/images/tilespuzzle.png", __ASSET__assets_images_tilespuzzle_png);
		type.set ("assets/images/tilespuzzle.png", AssetType.IMAGE);
		className.set ("assets/images/tilespuzzleB.png", __ASSET__assets_images_tilespuzzleb_png);
		type.set ("assets/images/tilespuzzleB.png", AssetType.IMAGE);
		className.set ("assets/images/trigger.png", __ASSET__assets_images_trigger_png);
		type.set ("assets/images/trigger.png", AssetType.IMAGE);
		...
		var id;
		id = "assets/data/Alone.oep";
		path.set (id, id);
		
		type.set (id, AssetType.TEXT);
		id = "assets/data/testlvl.oel";
		path.set (id, id);
		...
		type.set (id, AssetType.IMAGE);
		id = "assets/images/tilespuzzle.png";
		path.set (id, id);
		
		type.set (id, AssetType.IMAGE);
		id = "assets/images/tilespuzzleB.png";
		path.set (id, id);
		
		type.set (id, AssetType.IMAGE);
		id = "assets/images/trigger.png";
		path.set (id, id);
...
@:keep @:bind #if display private #end class __ASSET__assets_data_alone_oep extends null { }
@:keep @:bind #if display private #end class __ASSET__assets_data_testlvl_oel extends null { }
...
@:keep @:bind #if display private #end class __ASSET__assets_images_checkpoint_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
...
@:keep @:bind #if display private #end class __ASSET__assets_images_nyasheet_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
...
@:keep @:bind #if display private #end class __ASSET__assets_images_tilespuzzle_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind #if display private #end class __ASSET__assets_images_tilespuzzleb_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind #if display private #end class __ASSET__assets_images_trigger_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
...
@:file("assets/data/Alone.oep") #if display private #end class __ASSET__assets_data_alone_oep extends lime.utils.Bytes {}
@:file("assets/data/testlvl.oel") #if display private #end class __ASSET__assets_data_testlvl_oel extends lime.utils.Bytes {}
...
@:image("assets/images/checkpoint.png") #if display private #end class __ASSET__assets_images_checkpoint_png extends lime.graphics.Image {}
@:image("assets/images/door.png") #if display private #end class __ASSET__assets_images_door_png extends lime.graphics.Image {}
@:image("assets/images/nyasheet.png") #if display private #end class __ASSET__assets_images_nyasheet_png extends lime.graphics.Image {}
...
@:image("assets/images/tilespuzzle.png") #if display private #end class __ASSET__assets_images_tilespuzzle_png extends lime.graphics.Image {}
@:image("assets/images/tilespuzzleB.png") #if display private #end class __ASSET__assets_images_tilespuzzleb_png extends lime.graphics.Image {}
@:image("assets/images/trigger.png") #if display private #end class __ASSET__assets_images_trigger_png extends lime.graphics.Image {}
